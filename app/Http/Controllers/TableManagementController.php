    ...
    public function addNewContent(Request $request)
    {
        ...
        foreach ($request->inputs as $partition) {
            $contents[] = [
                ...
                'h_44' => $partition['h_44'],
                'h_44_finished' => $partition['h_44_finished'],
                'h_32' => $partition['h_32'],
                'h_32_finished' => $partition['h_32_finished'],
                'h_22' => $partition['h_22'],
                'h_22_finished' => $partition['h_22_finished'],
                'h_21' => $partition['h_21'],
                'h_21_finished' => $partition['h_21_finished'],
                'h_8' => $partition['h_8'],
                'h_8_finished' => $partition['h_8_finished'],
                'h_3' => $partition['h_3'],
                'h_3_finished' => $partition['h_3_finished'],
                'h_2' => $partition['h_2'],
                'h_2_finished' => $partition['h_2_finished'],
                'h' => $partition['h'],
                'h_finished' => $partition['h_finished'],
